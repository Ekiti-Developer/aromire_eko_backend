...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0002_remove_homepage_stat_communities_and_more'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            name='brevo_list_id',
            field=models.PositiveIntegerField(blank=True, help_text='Optional Brevo list ID. Leave blank to use BREVO_DEFAULT_LIST_ID from settings.', null=True),
        ),
        migrations.AddField(
            model_name='contactpage',
            name='from_address',
        ...
        migrations.AddField(
            model_name='contactpage',
            name='thank_you_text',
            field=models.TextField(blank=True, default='Thank you for reaching out. We will get back to you soon.'),
        ),
        migrations.AddField(
            model_name='contactpage',
            name='to_address',
